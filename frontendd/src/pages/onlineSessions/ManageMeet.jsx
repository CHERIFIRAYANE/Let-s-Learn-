...
export default function ManageMeet() {
    const [formData, setFormData] = useState({
      ...
      const postmeet = () => {
        ...
        axios.post(`http://127.0.0.1:8000/api/meets/`, {
          ...
          .then(response => {
            ...
            console.log('Meet posted:', response.data);
          })
          .catch(error => {
            console.error('Error posting the meet:', error);
          });
      };
  return (
